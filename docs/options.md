...
[collapse|collapse-preserve-inline|expand|end-expand|none] (Supported by terraformfmt)
...
Break chained method calls across subsequent lines (Supported by terraformfmt)
...
Override EOL from line-ending-selector (Supported by terraformfmt)
...
If a terminating comma should be inserted into arrays, object literals, and destructured objects. (Supported by terraformfmt)
...
End output with newline (Supported by terraformfmt)
...
Indentation character (Supported by terraformfmt)
...
Initial indentation level (Supported by terraformfmt)
...
Indentation size/length (Supported by terraformfmt)
...
Indentation uses tabs, overrides `Indent Size` and `Indent Char` (Supported by terraformfmt)
...
Enable jslint-stricter mode (Supported by terraformfmt)
...
Preserve array indentation (Supported by terraformfmt)
...
Number of line-breaks to be preserved in one chunk (Supported by terraformfmt)
...
Preserve line-breaks (Supported by terraformfmt)
...
Add a space before an anonymous function's parens, ie. function () (Supported by terraformfmt)
...
Add padding spaces within paren, ie. f( a, b ) (Supported by terraformfmt)
...
Decode printable characters encoded in xNN notation (Supported by terraformfmt)
...
Wrap lines at next opportunity after N characters (Supported by terraformfmt)
