...
| exfmt | :warning: 1 executable | :white_check_mark: :100:% of executables | :whale: With [Docker](https://www.docker.com/):<br/>1. Install [exfmt (`mix`)](https://github.com/lpil/exfmt) with `docker pull unibeautify/exfmt`<br/><br/>:bookmark_tabs: Manually:<br/>1. Install [exfmt (`mix`)](https://github.com/lpil/exfmt) by following https://github.com/lpil/exfmt<br/> |
