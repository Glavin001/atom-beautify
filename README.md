...
| exfmt | :warning: 1 executable | :x: No Docker support | :bookmark_tabs: Manually:<br/>1. Install [exfmt (`mix`)](https://github.com/lpil/exfmt) by following https://github.com/lpil/exfmt<br/> |
